    ...
    <div className="space-y-7 sm:space-y-9">
      ...
      <section>
        <div className="mb-4 flex items-center justify-between gap-3">
          <h2 className="text-lg font-bold text-[#e8eaef] sm:text-xl">
            Популярные игры
          </h2>
          {query.trim() && (
        ...
        {filteredGames.length === 0 ? (
          <div className="rounded-2xl border border-[#2a2d38] bg-[#181a21] px-6 py-14 text-center">
            <SearchX className="mx-auto size-9 text-[#6b7289]" />
            <p className="mt-3 font-semibold text-[#e8eaef]">Ничего не найдено</p>
